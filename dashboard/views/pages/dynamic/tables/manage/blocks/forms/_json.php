<?php if ($module->columns[$i]->type_column == "json"): ?>
	...
	<?php if (!empty($data) &&
    isset($data[$module->columns[$i]->title_column]) &&
    $data[$module->columns[$i]->title_column] != null): $arrayObj = new ArrayObject(json_decode(urldecode($data[$module->columns[$i]->title_column])));?>
