<?php if ($module->columns[$i]->type_column == "object"): ?>
	...
	<div class="itemsObject">
		...
		<?php if (!empty($data)): 
			$arrayObj = new ArrayObject(json_decode(urldecode($data[$module->columns[$i]->title_column]), true) ?? []); 
		?>
					...
					<div class="row row-cols-1 row-cols-sm-2 itemObject">
						...
						<div class="col">
							...
							<div class="form-floating mb-3">
								...
								style="top:0; right:0;"
								onclick="removeObject('<?php echo $module->columns[$i]->title_column ?>','_<?php echo $key ?>',event)">
									<i class="bi bi-x"></i>
								</button>
			...
			<?php else: ?>	
				...
				<div class="col">
					...
					<div class="form-floating mb-3">
						...
						<button type="button" class="btn btn-sm position-absolute" position="_0" style="top:0; right:0;" 
						onclick="removeObject('<?php echo $module->columns[$i]->title_column ?>','_0',event)">
							<i class="bi bi-x"></i>
						</button>
	...
	<?php if (!empty($data)): ?>
		...
		value='<?php echo !empty($data[$module->columns[$i]->title_column]) ? urldecode($data[$module->columns[$i]->title_column]) : "{}" ?>'>
